...
//		runNQueens();
	...
	{	
		...
		for (int i=0; i<worlds.length; i++)
		{
			...
			int x = cc2.expandContagion(theWorld, indices[i]);
			if (x ==0)
				cc2.printWorld(theWorld);
			System.out.println("expandContagion returned "+x+".");
		}
	}
	...
	public static void runNQueens()
	{
		System.out.println("N QUEENS");
		System.out.println("This method tries to arrange n queens on an n x n chessboard so that none of then are attacking each other.\nThis is finding ONE solution - there are probably several.");
		NQueens nq0 = new NQueens(4);
	    NQueens nq1 = new NQueens(5);
	    NQueens nq2 = new NQueens(8);
// This next one prints a LOT of debug statements -- activate it only when ready, perhaps with the DEBUG_MODE variable
// in the class set to false.
//	    NQueens nq3 = new NQueens(16);
